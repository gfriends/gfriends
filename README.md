...
### 上传新的演员图片
女友仓库欢迎所有人提交优质的演员头像图片或写真。

1. 移步至仓库的 [人工存储 HandStorage](https://github.com/xinxin8816/gfriends/tree/master/Content/0-Hand-Storage) 目录，这个目录拥有最高优先级，能保证上传的图片优先使用。
...
此外，如果您有大量的图片想要上传，可能您需要了解一点 Git。

### 提交新的来源网站
如果您有演员优质大图的来源网站，那就太完美了~

1. 您只需提交一个 Issues，告诉我网站地址即可。
2. 我会抽空改写后端适配它，之后会自动完成这一切。
